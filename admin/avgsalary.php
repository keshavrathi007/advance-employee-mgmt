...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form action="avgsalary.php" method="post" enctype="multipart/form-data">
      <div class="form-group">
       <table class="table table-striped table-dark">
  <tbody>
    <tr>
      <th scope="row" class="pt-3">EMPLOYEE FIELD</th>
      <td><input class="form-control" type="text" name="field" placeholder="Enter Employee Field" required></td>
    </tr>
        ...
        {   $count=0;
            while($data=mysqli_fetch_assoc($run))
            {
                ...
                <tr>
                      ...
                      <td scope="row"><?php echo $data['avg(salary)'];?></td>
