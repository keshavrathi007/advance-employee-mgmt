...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form action="searchbysalary.php" method="post" enctype="multipart/form-data">
      <div class="form-group">
       <table class="table table-striped table-dark">
  <tbody>
    <tr>
      <th scope="row" class="pt-3">EMPLOYEE SALARY</th>
      <td><input class="form-control" type="number" name="salary" placeholder="Enter Employee Salary" required></td>
    </tr>
  ...
  <tbody>
    ...
    if(isset($_POST['submit']))
        ...
        $sql="SELECT * FROM `student` WHERE `salary` LIKE '%$salary%'";
