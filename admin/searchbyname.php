...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form action="searchbyname.php" method="post" enctype="multipart/form-data">
      <div class="form-group">
       <table class="table table-striped table-dark">
  <tbody>
    <tr>
      <th scope="row" class="pt-3">EMPLOYEE NAME</th>
      <td><input class="form-control" type="text" name="name" placeholder="Enter Employee Name" required></td>
    </tr>
